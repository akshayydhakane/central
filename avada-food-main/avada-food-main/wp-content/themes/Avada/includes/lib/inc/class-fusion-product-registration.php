		...
		<div class="avada-db-reg-form-container">
			...
			<form class="avada-db-reg-form" method="post">
				<div class="avada-db-reg-input-wrapper">
					...
					?>
					<input type="text" class="avada-db-registration-input" name="<?php echo esc_attr( "{$this->option_name}[{$this->product_id}][token]" ); ?>" value="GPLD7514519919615182316RL"<?php echo esc_attr( $token ); ?>"<?php echo esc_attr( $disabled ); ?> />
				</div>
